...
function Home() { 
    ...
    const restaurants = [
        ...
        // Additional restaurants matching our backend menu
        {
            id: 6,
            name: "Pizza Bite",
        ...
        <div>
            ...
            >
                <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
                    <h1 className="pb-5 font-bold text-transparent bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-4xl">
                        FoodHub IIT Mandi
                    </h1>
